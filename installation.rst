...
structures of any byproducts that may be expected. Add additional columns into the platemap using
...
.. note::
	...
	Multiple byproducts can be listed, but each byproduct should appear in its own column. This may result in some 
	cells in the platemap table being empty, where that particular byproduct cannot be observed in that well, due to a particular plate design. 
...
.. csv-table:: Fully Elaborated Platemap
	:header-rows: 1
...
.. figure:: images/rt_refinement.png
	...
	Hit Validation Graph before and after a retention time is specified
...
* -o:  specify new output_directory
